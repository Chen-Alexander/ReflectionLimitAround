...
extern "C" jint JNI_OnLoad(JavaVM *vm, void *reserved) {
    ...
    globalVM = reinterpret_cast<JavaVM *>(currentEnv->NewGlobalRef(
            reinterpret_cast<jobject>(vm)));
//    globalVM = vm;
...
Java_com_alexander_reflectlimitaround_MainActivity_setHiddenApiExemptionsNative(JNIEnv *env,
                                                                                jobject thiz) {
